#!/bin/bash
# run_appinspect.sh — Splunk AppInspect for splunk_app_sap_logserv
#
# Usage:
#   ./run_appinspect.sh <package.tar.gz>
#
# Example:
#   ./run_appinspect.sh splunk_app_sap_logserv-0.0.3.tar.gz
#
# Prerequisites:
#   pip install splunk-appinspect
#
# This script runs AppInspect checks relevant to a hand-crafted Splunk app
# (no Python, no UCC, no REST handlers). It excludes checks that only apply
# to apps with scripted inputs or custom REST endpoints.
