...
## Version 0.0.1-beta (latest)

lorem ipsum

### :material-circle-box:{ .cboxcolor } Compatibility
...
### :material-circle-box:{ .cboxcolor } New features

lorem ipsum

### :material-circle-box:{ .cboxcolor } Fixed issues

lorem ipsum

### :material-circle-box:{ .cboxcolor } Known issues

lorem ipsum

### :material-circle-box:{ .cboxcolor } Third-party software attributions
