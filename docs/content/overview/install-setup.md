...
3. Follow the installation and setup options in the [Setup walkthroughs](../install-setup/setup-walkthroughs.md)


## :material-circle-box:{ .cboxmove } Next Steps

Start with the [Installation and Setup Prerequisites](../install-setup/prerequisites.md)